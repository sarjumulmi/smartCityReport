...
/**
 ...
 @param mobileResource MobileResource that is changed in the cache (the mobileResource can be either OMCMobileObject/OMCMobileObjectCollection/OMCMobileFile or a customClass object )
 */
