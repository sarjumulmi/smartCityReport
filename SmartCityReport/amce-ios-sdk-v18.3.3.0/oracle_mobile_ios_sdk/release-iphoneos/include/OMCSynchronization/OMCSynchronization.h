 ...
 */
@interface OMCSynchronization : OMCMobileBackendServiceProxy
 ...
 */
- (void) initializeWithMobileObjectEntities:(nullable NSArray *) customEntities;
 ...
 */
- (void) loadOfflineResourcesOnSuccess:(nullable OMCSyncMobileResourceArray) success
                               onError:(nullable OMCSyncErrorBlock) error;
 ...
 * Persistent state of the resources will remain in cache as is.
 @param error (optional) The block will be invoked on error.
 */
- (void) discardOfflineUpdatesOnError:(nullable OMCSyncErrorBlock) error;
...
/**
 The `synchronization` service's properties name.
 */
extern NSString* const OMCSynchronizationPropertyName;
